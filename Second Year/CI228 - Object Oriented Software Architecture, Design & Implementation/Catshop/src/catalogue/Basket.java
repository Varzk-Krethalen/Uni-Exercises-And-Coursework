...
public class Basket extends ArrayList<Product> implements Serializable
{
  ...
  /**
   * required to run without errors, as CashierModel by default looks to here:
   * when BetterBasket & its Model are in use, uses that remove & check method.
   * @param pn
   */
  public void removeItem(String pn, int amount) {}
  
  public int checkAmount(String pn) {return 0;}
