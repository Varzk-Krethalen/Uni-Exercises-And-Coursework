...
public class ProcessMoney
{
  ...
  {
    if (coin == 10) {tp10++;}
    else if (coin == 20) {tp20++;}
    else if (coin == 50) {tp50++;}
    else if (coin == 100) {tp100++;}
    else if (coin == 200) {tp200++;}
    theCredit += coin;
    theMoneyInTheMachine += coin;
  } 
  ...
  {
    int money = theMoneyInTheMachine;
    return money;
  }
